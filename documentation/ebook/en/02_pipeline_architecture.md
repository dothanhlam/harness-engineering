...
6. **DEVOPS & MEMORY COMPACTION**: The system generates release notes, exports `telemetry.json`, and leverages **MCP tools** to automatically update ticket trackers (like Linear) so you don't have to manually update project boards.
